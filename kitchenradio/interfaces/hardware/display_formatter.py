...
class DisplayFormatter:
    ...
    def _draw_heart(self, target_draw: ImageDraw.Draw, target_img: Image.Image, 
        ...
        triangle_top_y = circles_cy + circle_radius // 4   # Moved down 3 pixels
        triangle_left_x = left_circle_cx - circle_radius + 1 // 2
        triangle_right_x = right_circle_cx + circle_radius + 1// 2
        
        # Bottom point (90° angle, 45° slopes)
        # For 45° slopes: height = half of base width
        triangle_base = triangle_right_x - triangle_left_x
        triangle_height = int(triangle_base / 2) + 1
