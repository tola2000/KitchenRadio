...
class MoOdeAudioController:
    ...
    def get_status(self) -> Optional[Dict]:
        ...
        """
        return self._make_request("/command/?cmd=get_status")
    ...
    def play(self) -> bool:
        ...
        """
        result = self._make_request("/command/?cmd=play", "POST")
    ...
    def pause(self) -> bool:
        ...
        Returns:
            True if command was successful, False otherwise
        """
        result = self._make_request("/command/?cmd=pause", "POST")
        return result is not None
    ...
    def stop(self) -> bool:
        ...
        Returns:
            True if command was successful, False otherwise
        """
        result = self._make_request("/command/?cmd=stop", "POST")
        return result is not None
    ...
    def next_track(self) -> bool:
        ...
        Returns:
            True if command was successful, False otherwise
        """
        result = self._make_request("/command/?cmd=next", "POST")
        return result is not None
    ...
    def previous_track(self) -> bool:
        ...
        Returns:
            True if command was successful, False otherwise
        """
        result = self._make_request("/command/?cmd=previous", "POST")
        return result is not None
    ...
    def set_volume(self, volume: int) -> bool:
        ...
        result = self._make_request(f"/command/?cmd=set_volume&volume={volume}", "POST")
        return result is not None
    ...
    def get_current_song(self) -> Optional[Dict]:
        ...
        """
        return self._make_request("/command/?cmd=get_currentsong")
    ...
    def get_playlist(self) -> Optional[List[Dict]]:
        ...
        """
        return self._make_request("/command/?cmd=get_playlist")
    ...
    def seek(self, position: float) -> bool:
        ...
        Returns:
            True if command was successful, False otherwise
        """
        result = self._make_request(f"/command/?cmd=seek&pos={position}", "POST")
        return result is not None
